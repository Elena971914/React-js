  ...
  const onEditIconClick = () => {
    ...
    return(
        ...
        <td className="actions">
          <button className="btn edit-btn" title="Edit" onClick={onEditIconClick}>
          ...
          <button className="btn delete-btn" title="Delete" onClick={onDeleteIconClick}>
          ...
          <button className="btn info-btn" title="Info">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="info" onClick={onInfoIconClick}
